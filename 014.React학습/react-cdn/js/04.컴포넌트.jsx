...
/********************************************** 
    ...
    -> 클래스형 컴포넌트는 리액트 주로
    사용되었으나.. React 16.8버전에서 Hooks와 함께는
    더 이상 사용되지 않는다.
    ...
    [ 클래스 컴포넌트 ]
    클래스 컴포넌트에서는 
    extends React.Commponent 상속문이 포함돼야함!
    ...
    class Gogh extends React.Component {
        ...
        render(){
            ...
            return (
                <React.Fragment>
                    <h2>안녕! 나는 고흐그림이야!</h2>
                    <img src="./images/01.png" alt="고흐1"></img>
                    {/* 홀로태그는 반드시 끝에 닫아준다! */}
                </React.Fragment>
            )
...
**********************************************/
// 내가 좋아하는 색 표시하기 컴포넌트 //
function Favorite(헐){ // props는 속성셋팅 변수집합
    return (<h2>
...
// 함수 컴포넌트에서는 표현식 안에서 {props.호출시용용한속성명}
