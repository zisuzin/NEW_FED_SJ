...
window.addEventListener("DOMContentLoaded",()=>{
    ...
    btngo.onclick = () => {
        ...
        // 현재 큐브에 "on"클래스가 있는 여부검사
        let isOn = cube.classList.contains("on");
        console.log("on있냐?",isOn);

        // 3. 버튼 텍스트 변경하기
        btngo.innerText = isOn?"멈춰!":"돌아!"; //btngo라는 버튼 안에 isOn(작동)이 들어있냐? 있으면 멈춰, 없으면 돌아   
    ...
    **********************************************/
    ...
    const menu = document.querySelector(".tit a");
    // 변경 대상: 태양계 전체를 싸고 있는 부모 요소 -> .scbx
